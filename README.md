...
| 7 | **Hedging Analytics** | Konkrete Delta-/Gamma-/Delta-Gamma-Hedge-Trades je Underlying, Hedge-Instrument-Auswahl (manuell/Vorlage/Auto-Optimierung), Rundungsvarianten, Hedge-Kosten, Greeks vor/nach, Delta-/Gamma-Verlauf, P&L-Profil, Szenario nach Hedge |
...
│   ├── hedging.py             # Hedge-Logik: per-Underlying Greeks, Delta/Gamma/DG-Hedge
│   ├── hedge_optimizer.py     # diskrete Hedge-Optimierung (gewichtetes Ziel)
